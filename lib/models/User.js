...
const schema = new Schema({
    ...
    options: {
        n: { action: String, fluff: { type: Schema.Types.ObjectId, ref: 'Fluff' } },
        s: { action: String, fluff: { type: Schema.Types.ObjectId, ref: 'Fluff' } },
        e: { action: String, fluff: { type: Schema.Types.ObjectId, ref: 'Fluff' } },
        w: { action: String, fluff: { type: Schema.Types.ObjectId, ref: 'Fluff' } }
    },
    roles: [String]
});
